...
{
    public class DepositTransactionCommand(Money amount, string accountNumber, int categoryId, MerchantOption merchantOption, TagOption[]? tags = null, long? createdOn = null)
    {
